...
export function GitHubStatus() {
    ...
    // Listen for reconnection (when user comes back from OAuth)
    // Also listen for user sign-out events
    useEffect(() => {
        ...
        const handleUserSignOut = () => {
            // User signed out, clear GitHub status
    ...
    const handleDisconnect = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                window.dispatchEvent(new Event('github-disconnected'));
            }
        } catch (error) {
            ...
            <Dialog open={showDialog} onOpenChange={setShowDialog}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            This will disconnect your GitHub account ({user.username}). You can connect again anytime.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                        <Button
