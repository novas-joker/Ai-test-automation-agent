...
export default function Home() {
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col bg-dotted relative">
      {/* Header */}
      ...
      {/* Hero Section */}
      <main className="flex-grow flex flex-col items-center justify-center max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center relative z-10">
        ...
        {/* Features Section */}
        <section id="features" className="w-full pt-10 border-t border-border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            <div className="border border-border rounded-lg p-6 bg-card/40 backdrop-blur-sm">
        ...
        <section id="architecture" className="w-full mt-24 border border-border rounded-lg overflow-hidden bg-zinc-950/80 text-left font-mono text-xs shadow-2xl">
